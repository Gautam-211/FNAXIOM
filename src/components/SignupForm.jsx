...
//   const [accountType, setAccountType] = useState(ACCOUNT_TYPE.STUDENT);
  ...
  return (
    <div>
      {/* Form */}
      <form onSubmit={handleOnSubmit} className="flex items-center mt-[8rem] flex-col gap-y-4 w-1/2 mx-auto inset-0 bg-white bg-opacity-30 backdrop-blur-md px-4 py-6 rounded-lg">
